...
An interactive version of this visualization is provided as a standalone HTML file (\texttt{artifacts/parallel\_coordinates.html}) built with Facebook's HiPlot library, allowing the client to dynamically filter, reorder columns, and brush selections.
